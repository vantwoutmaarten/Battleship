(function(exports){
    ...
    /* 
     * Player A to server OR server to Player B: Location of enemy ships; 
     */



     /* 
     * Player B to server OR server to Player A: Location of enemy ships;
     */
    ...
    /*
     * Server to client: Shot fired at location (X,Y)
     */
    ...
    /* 
     * Player A to server OR server to Player B: Shot fired at location(X,Y)
     */
    ...
    /* 
     * Player B to server OR server to Player A: Shot fired at locaction(X,Y)
     */
